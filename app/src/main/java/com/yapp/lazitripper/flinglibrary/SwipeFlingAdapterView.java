package com.yapp.lazitripper.flinglibrary;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
        ...
        if(getChildCount()>0){
            ...
            if(mActiveCard!=null) {
                flingCardListener = new FlingCardListener(mActiveCard, mAdapter.getItem(0),
                    ...
                    @Override
                    public void onClick(Object dataObject, View frame) {
                        if(mOnItemClickListener!=null)
                            mOnItemClickListener.onItemClicked(0, dataObject,frame);
    ...
    public interface OnItemClickListener {
        void onItemClicked(int itemPosition, Object dataObject, View frame);
    }
