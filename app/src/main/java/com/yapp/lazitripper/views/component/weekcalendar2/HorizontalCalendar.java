...
public class HorizontalCalendar {
    ...
    private ArrayList<ChooseDate> mListDays;
    ...
    //choose date
    private ArrayList<Date> chooseDateArrayList;
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                ...
                if (calendarListener != null) {
                    calendarListener.onDateSelected(mListDays.get(position).getDate(), position);
                }
    ...
    private HorizontalCalendar(Builder builder) {
        ...
        this.chooseDateArrayList = builder.chooseDateArrayList;
    ...
    public Date getSelectedDate() {
        return mListDays.get(calendarView.getPositionOfCenterItem()).getDate();
    }
     ...
     */
    public ChooseDate getDateAt(int position) throws IndexOutOfBoundsException {
     ...
     */
    public boolean contains(ChooseDate date) {
    ...
    public ArrayList<Date> getChooseDateArrayList() {
    ...
    public int positionOfDate(Date date) {
        ...
        for (int i = 0; i < mListDays.size(); i++) {
            if (isDatesDaysEquals(date, mListDays.get(i).getDate())) {
                position = i;
                break;
            }
        }
    ...
    public static class Builder {
        ...
        ArrayList<Date> chooseDateArrayList;
        ...
        public Builder setChooseDate(ArrayList<Date> chooseDateArrayList) {
            this.chooseDateArrayList = chooseDateArrayList;
            return this;
        }
    ...
    private class InitializeDatesList extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            chooseDate.setChoose(false);
            for (Date isChoose:chooseDateArrayList) {
                SimpleDateFormat fmt = new SimpleDateFormat("yyyyMMdd");
                if(fmt.format(isChoose).equals(fmt.format(date))){
                    chooseDate.setChoose(true);
                    break;
                }
            }
            while (!date.after(dateEndAfter)) {
                mListDays.add(chooseDate);
            ...
            ArrayList<ChooseDate> dd = mListDays;
            Date date22 = dateStartBefore;
            return null;
        }
