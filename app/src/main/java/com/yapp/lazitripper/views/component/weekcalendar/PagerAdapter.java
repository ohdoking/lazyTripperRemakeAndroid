...
import static com.yapp.lazitripper.views.component.weekcalendar.WeekFragment.DATE_KEY;
import static com.yapp.lazitripper.views.component.weekcalendar.WeekPager.NUM_OF_PAGES;
...
public class PagerAdapter extends FragmentStatePagerAdapter {
    ...
    public PagerAdapter(Context context, FragmentManager fm, DateTime date, TypedArray typedArray, PickDate pickDate) {
        super(fm);
        this.date = date;
